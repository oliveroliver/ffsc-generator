...
segment_length = [15, 15, 5, 15.3, 15]  # this specifies both the length of each straight segment
segment_angle = [45, -180, 180, -45]  # this specifies the angle of each join / curved section. There should be one less angle than connections in length list
segment_inner_radius = [2, 2, 2, 2]  # the radius of each angle
