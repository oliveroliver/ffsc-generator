...
triangles_across_width = 7  # the number of triangles that are used for stress relief spacing
triangle_height = 10  # the total height of each triangle
taper_distance_from_edge = 4.0  # the distance from the edge of the connector before the taper starts
pad_arc_height = 0.9  # the height of the arc - MUST BE >= smallest pad width / 2
distance_arc_from_edge = 2.8  # the distance of the pad arc start point from the edge of the connector - should really be above the via point
...
segment_length = [55, 0, 55]  # this specifies both the length of each straight segment
...
segment_inner_radius = [0, 0]  # the radius of each angle

track_widths = [0.15, 0.15, 0.15, 0.15, 0.5, 0.5, 0.5, 0.5, 1.0, 1.0, 1.0, 1.0, 2.0, 2.0, 3.0]
